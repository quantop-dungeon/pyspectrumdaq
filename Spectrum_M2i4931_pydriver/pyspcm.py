...
from pymodules.instruments.Spectrum_M2i4931_pydriver.py_header.regs import *

# load registers for easier access
from pymodules.instruments.Spectrum_M2i4931_pydriver.py_header.spcerr import *
